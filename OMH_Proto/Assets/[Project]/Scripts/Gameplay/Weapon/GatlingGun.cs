...
public class GatlingGun : Weapon
{
    ...
    public override void Attack()
    {
        ...
        newProj.Initialize(this.gameObject, _stat.projectileSpeed.Value, _stat.damage.Value);
    ...
    public override void SecondaryAttack()
    {
        ...
        newProj.Initialize(this.gameObject, _secondaryStat.projectileSpeed.Value, _secondaryStat.damage.Value);
    }
}
